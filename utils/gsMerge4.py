...
if __name__ == "__main__":
    ...
    R2tmp = np.array([[0.49859994649887085, -0.2384999692440033, 0.8333998918533325], 
                      [0.28610000014305115, 0.9527999758720398, 0.10159999877214432], 
                      [-0.8183000683784485, 0.18780003488063812, 0.5433000326156616]])
    ...
    offset = torch.tensor(np.array([-0.0409008227288723, -0.0027861243579536676, -0.05902460962533951]), dtype=torch.float32, device = 'cuda')
    #scale
    T2 = T2 * 16.9 + offset
